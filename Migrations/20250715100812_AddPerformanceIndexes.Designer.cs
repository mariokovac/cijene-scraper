...
namespace CijeneScraper.Migrations
{
    ...
    [Migration("20250715100812_AddPerformanceIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.ApplicationLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.Price", b =>
                {
                    ...
                    b.HasIndex(new[] { "Date", "StoreId" }, "IX_Prices_Date_StoreId");
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.ScrapingJob", b =>
                {
                    ...
                    b.Property<long?>("ScrapingJobLogId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.ScrapingJobLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("StoresProcessed")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ChainID", "Date", "StartedAt");
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.Store", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChainId" }, "IX_Stores_ChainId");

                    b.HasIndex(new[] { "Code", "ChainId" }, "IX_Stores_Code_ChainId");
            ...
            modelBuilder.Entity("CijeneScraper.Models.Database.ScrapingJob", b =>
                {
                    ...
                    b.HasOne("CijeneScraper.Models.Database.ScrapingJobLog", "ScrapingJobLog")
                        .WithMany()
                        .HasForeignKey("ScrapingJobLogId");

                    b.Navigation("Chain");

                    b.Navigation("ScrapingJobLog");
                });
